...
<div class="px-4 pt-8">
  ...
  <div class="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
    <div class="flex flex-col rounded-lg bg-white sm:flex-row">
      <img class="m-2 h-24 w-28 rounded-md border object-cover object-center" src="https://down-id.img.susercontent.com/file/83d50cc446aec928107a6c6bc66a309f" alt="" />
...
<div class="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
  ...
  <div class="">
    ...
    <div class="mt-6 flex items-center justify-between">
      ...
      <p class="text-2xl font-semibold text-gray-900">Rp.400.000</p>
    </div>
  </div>
