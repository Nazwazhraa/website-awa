      ...
      <div class="px-4 py-6 sm:px-8 sm:py-10">
        <div class="flow-root">
          <ul class="-my-8">
            <li class="flex flex-col space-y-3 py-6 text-left sm:flex-row sm:space-x-5 sm:space-y-0">
              <div class="shrink-0">
                <img class="h-24 w-24 max-w-full rounded-lg object-cover" src="https://down-id.img.susercontent.com/file/83d50cc446aec928107a6c6bc66a309f" alt="" />
              </div>
              ...
              <div class="relative flex flex-1 flex-col justify-between">
                <div class="sm:col-gap-5 sm:grid sm:grid-cols-2">
                  <div class="pr-8 sm:pr-5">
                    ...
                    <p class="mx-0 mt-1 mb-0 text-sm text-gray-400">36-45</p>
                  </div>
        ...
        <div class="mt-6 border-t border-b py-2">
          ...
          <div class="flex items-center justify-between">
            ...
            <p class="text-lg font-semibold text-gray-900">Rp.100.000</p>
          </div>
        </div>
        <div class="mt-6 flex items-center justify-between">
          <p class="text-sm font-medium text-gray-900">Total</p>
          <p class="text-2xl font-semibold text-gray-900"><span class="text-xs font-normal text-gray-400">Rp</span>400.000</p>
        </div>
